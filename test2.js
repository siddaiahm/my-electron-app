...
let Meter = function Meter($elm,config){
    ...
    let value2percent = function(value) {
    ...
    this.setValue = function(v) {
		let percent = value2percent(v);
		if(v>= config.valueRed ){
    ...
    makeElement($elm, "bar-bottom","<div class='bar-bottom1'></div>");
    makeElement($elm,"inner-circle");
